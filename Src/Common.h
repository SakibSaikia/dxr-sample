...
constexpr size_t k_shaderRecordSize = (D3D12_SHADER_IDENTIFIER_SIZE_IN_BYTES + k_maxRootSignatureSize + (D3D12_RAYTRACING_SHADER_TABLE_BYTE_ALIGNMENT - 1)) & ~(D3D12_RAYTRACING_SHADER_TABLE_BYTE_ALIGNMENT - 1);
